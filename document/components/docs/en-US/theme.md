...
$action-sheet-active-color := $color-primary
...
$btn-primary-bgc := $color-primary
$btn-primary-bdc := $color-primary
$btn-primary-active-bgc := $color-dark-primary
$btn-primary-active-bdc := $color-dark-primary
/// light
...
/// outline-primary
$btn-outline-primary-color := $color-primary
$btn-outline-primary-bgc := transparent
$btn-outline-primary-bdc := $color-primary
$btn-outline-primary-active-bgc := $color-primary-opacity
$btn-outline-primary-active-bdc := $color-dark-primary
...
$dialog-btn-highlight-color := $color-primary
$dialog-btn-highlight-active-bgc := $color-light-primary-opacity
...
$index-list-nav-active-color := $color-primary

// picker
$picker-bgc := $color-white
$picker-title-color := $color-dark-grey
$picker-confirm-btn-color := $color-primary
$picker-confirm-btn-active-color := $color-light-primary
...
$slide-dot-active-bgc := $color-primary
